  ...
  return (
    ...
    <div className="flex w-screen h-[40vh] justify-center content-center min-[320px]:text-center max-md:hidden ">
        ...
        <div className=" w-[50%] h-full flex items-center justify-around">
            ...
            <img className="w-[150px] h-[10px] mt-[-25px] md:h-[140px] lg:h-[170px]" src={categories[counter]?.character_photo} />
            <img className="w-[140px] h-[10px] mt-[-45px] md:h-[130px] lg:h-[180px]" src={categories[counter]?.cover_photo} />
        </div>
        <div className=" w-[50%] h-full flex items-center justify-around">
